...
def run_sanity_check(test_dir):
    ...
    if not test_functions_for_post:
        ...
        if len(test_functions_for_post) == 1:
            ...
            print(
                FAIL_COLOR +
                "Only one test case was\
                    detected for the POST() method."
            )
            print(
                FAIL_COLOR + "Please make sure you\
                    have two test cases for the POST() method.\n"
                "One test case for EACH of the possible\
                    inferences (results/outputs)\
                        of the ML model.\n")
            SANITY_TEST_PASSING = False
        ...
        if not TEST_FOR_POST_METHOD_RESPONSE_CODE:
            ...
            print(
                FAIL_COLOR +
                "One or more of your test cases\
